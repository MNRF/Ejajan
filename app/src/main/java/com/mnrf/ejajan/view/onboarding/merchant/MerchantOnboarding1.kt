...
class MerchantOnboarding1 : Fragment() {

    private var _binding: MerchantOnboarding1Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = MerchantOnboarding1Binding.inflate(inflater, container, false)
        return binding.root
    }
